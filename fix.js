...
if(!om)return;
q[m]=function(body){return smart(om,of,body);};
});
return q;
};
}catch(e){}
...
setTimeout(function(){
var els=document.querySelectorAll('footer,p,span,small');
for(var i=0;i<els.length;i++){
var el=els[i];
if(el.children.length===0&&el.innerText&&
el.innerText.indexOf('DukaFlow v')>-1&&
